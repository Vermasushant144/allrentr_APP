...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Use deep link scheme for native, web origin for browser
      const redirectTo = isNative
        ? 'com.allrentr.app://auth/callback'
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          redirectTo,
          skipBrowserRedirect: isNative, // Don't auto-open system browser
        },
      });
      ...
      // On native, open the OAuth URL in Capacitor's in-app browser
